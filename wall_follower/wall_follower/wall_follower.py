...
class WallFollower(Node):
    ...
    def __init__(self):
        ...
        self.drive_input_publisher = self.create_publisher(AckermannDriveStamped, "/vesc/low_level/input/navigation", 10) # Set to self.DRIVE_TOPIC to circumvent the safety controller
